...
public class MainMethod {
	...
	public static void main(String[] args) {
		...
		Assert.assertEquals(0, obj.AddIgnoreMoreThan1000(""));
		Assert.assertEquals(0, obj.AddIgnoreMoreThan1000(","));
		Assert.assertEquals(1, obj.AddIgnoreMoreThan1000("1"));
		Assert.assertEquals(1+2, obj.AddIgnoreMoreThan1000("1,2"));
		Assert.assertEquals(1+2, obj.AddIgnoreMoreThan1000("1,2"));
		Assert.assertEquals(1+2+3, obj.AddIgnoreMoreThan1000("1,2,3"));
		//Assert.assertEquals(NumberFormatException.class, obj.Add_with_handle_new_line("1,2,33333333333"));   //  throws  "Not a Valid Number"
		
		Assert.assertEquals(0, obj.AddIgnoreMoreThan1000("\n"));
		Assert.assertEquals(1, obj.AddIgnoreMoreThan1000("\n1"));
		Assert.assertEquals(1+2+3, obj.AddIgnoreMoreThan1000("1,2\n3"));
		Assert.assertEquals(1+2, obj.AddIgnoreMoreThan1000("1\n2"));
		Assert.assertEquals(1+2+3, obj.AddIgnoreMoreThan1000("1\n2\n3"));
		
		Assert.assertEquals(0, obj.AddIgnoreMoreThan1000("//:\n"));
		Assert.assertEquals(6, obj.AddIgnoreMoreThan1000("//'\n1'2'3"));
		Assert.assertEquals(1, obj.AddIgnoreMoreThan1000("//:\n1"));
		Assert.assertEquals(1+2+3, obj.AddIgnoreMoreThan1000("//;\n1;2;3"));
		Assert.assertEquals(1+2, obj.AddIgnoreMoreThan1000("//:\n1:2"));
		Assert.assertEquals(1+2+3, obj.AddIgnoreMoreThan1000("//,\n1,2,3"));
		...
		Assert.assertEquals(3, obj.AddIgnoreMoreThan1000("//'\n1'2'3000"));
		Assert.assertEquals(0, obj.AddIgnoreMoreThan1000("//:\n1100"));
		Assert.assertEquals(1+3, obj.AddIgnoreMoreThan1000("//;\n1;2000;3"));
		Assert.assertEquals(1002, obj.AddIgnoreMoreThan1000("//:\n1000:2"));
		Assert.assertEquals(1+3, obj.AddIgnoreMoreThan1000("//,\n1,2000,3"));
